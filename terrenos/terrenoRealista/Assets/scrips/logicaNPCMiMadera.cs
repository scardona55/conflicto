...
public class logicaNPCMiMadera : MonoBehaviour
{
    ...
    public logicaMisionMadera logicaMision;
    ...
    void Start()
    {
        ...
        // Desactivar los objetivos desde el inicio
        objetivos = GameObject.FindGameObjectsWithTag("madera");
